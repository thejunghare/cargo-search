    ...
    "src/view/webview.js"(exports, module) {
      ...
      module.exports = (emitter2, state2) => {
        ...
        const create = (src) => {
          ...
          const isVertical = state2.tabLayout === "vertical";
      ...
      <webview id="${id}" src="${src}" allowpopups autosize style="width: 100%; height: 100%;"></webview>
    </div>`;
...
`;
    ...
    <div id="titlebar" class="${topbarStyle}">
      <div class="bar">
        ...
        <div class="controls">
          ${btn("layout", () => {
          const nextLayout = state2.tabLayout === "horizontal" ? "vertical" : "horizontal";
          emitter2.emit("tabs-layout-change", nextLayout);
        })}
